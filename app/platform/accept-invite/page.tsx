...
import { KeyRound, ShieldCheck, UserCheck, ArrowRight, Loader2, Lock, CheckCircle2 } from "lucide-react"
...
function AcceptInviteContent() {
  ...
  return (
    <div className="min-h-screen bg-bg-secondary flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-bg-primary rounded-2xl border border-border p-8 shadow-lg space-y-6">
        {/* Header Branding */}
        <div className="text-center space-y-2">
          <div className="inline-flex h-12 w-12 rounded-xl bg-primary items-center justify-center text-white font-bold text-2xl shadow-md mb-2">
            N
          </div>
          ...
          <p className="text-xs text-text-secondary">
            Accept your administrative invitation to the Nexlin ecosystem.
          </p>
        </div>
