...
export default async function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div 
      className="w-full h-full bg-[#050505] text-white selection:bg-primary/30"
      style={{
    ...
    >
      <div className="fixed inset-0 z-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-primary/10 via-[#050505] to-[#050505] opacity-60 pointer-events-none" />
