        ...
        {tempPassword ? (
          <div className="py-2 space-y-4">
            <div className="rounded-lg bg-amber-500/10 border border-amber-500/20 p-4 space-y-2">
              <p className="text-sm font-semibold text-amber-600">⚠️ Temporary Password — Show Once</p>
              <p className="text-xs text-text-secondary">Share this with the new tenant. They must use the forgot-password flow to set their own password.</p>
              <code className="block mt-2 p-2 rounded bg-bg-secondary text-sm font-mono text-text-primary select-all">{tempPassword}</code>
            </div>
            <div className="flex justify-end">
              <Button onClick={() => { setTempPassword(null); setOpen(false) }}>
